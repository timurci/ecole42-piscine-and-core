...
{
	std::string	username	= findUsername(cmd_info.params);
	std::string realname	= findRealname(cmd_info.params);
	...
	if (username.empty() || realname.empty())
		...
		client.appendSendBuffer(ERR_ALREADYREGISTERED(client.getNickname()));
	else
	{
